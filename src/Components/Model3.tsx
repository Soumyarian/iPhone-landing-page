...
export function Model3(props: any) {
  ...
  const { textColor, rightColor } = useColorSectionContext();

  useEffect(() => {
    materials.Body.color.set(textColor);
    materials.Logo.color.set(rightColor);
    materials.Glass.color.set(rightColor);
    materials["Camera_Frame.001"].color.set(textColor);
  }, [textColor]);

  useLayoutEffect(() => {
    camera.position.set(-0.01, 0.22, 5);
